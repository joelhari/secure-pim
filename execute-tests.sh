...
./build/additions > ../results/res-additions-0-0-$1.txt
...
./build/additions > ../results/res-additions-0-1-$1.txt
...
./build/additions > ../results/res-additions-1-1-$1.txt
...
# ./build/additions > ../results/res-additions-1-0-$1.txt
